...
using ClickMart.Domain.Exceptions.Auth;
using ClickMart.Domain.Exceptions.Users;
using ClickMart.Service.Common.Helpers;
using ClickMart.Service.Common.Security;
using ClickMart.Service.Dtos.Auth;
using ClickMart.Service.Dtos.Notifications;
using ClickMart.Service.Dtos.Security;
using ClickMart.Service.Interfaces.Auth;
using ClickMart.Service.Interfaces.Notifcations;
using Microsoft.Extensions.Caching.Memory;


namespace ClickMart.Service.Services.Auth;
